...
//        	centerMarker.setIcon(BitmapDescriptorFactory.fromResource(centerDrawableId));
        	centerMarker.setIcon(MapUtils.bitmapDescriptorFromVector(centerDrawableId));
        }
        
        radiusMarker = map.addMarker(new MarkerOptions()
	        .position(MapUtils.toRadiusLatLng(center, radiusMeters))
...
//        	radiusMarker.setIcon(BitmapDescriptorFactory.fromResource(radiusDrawableId));
        	radiusMarker.setIcon(MapUtils.bitmapDescriptorFromVector(radiusDrawableId));
        }
    ...
    public MarkerMoveResult onMarkerMoved(Marker marker) {
        ...
        if (marker.equals(radiusMarker)) {
        	 double newRadius = MapUtils.toRadiusMeters(centerMarker.getPosition(), marker.getPosition());
    ...
    public void onCenterUpdated(LatLng center) {
        ...
        radiusMarker.setPosition(MapUtils.toRadiusLatLng(center, radiusMeters));
    }
